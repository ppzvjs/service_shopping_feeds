...
class Product
{
    ...
    private ?string $remoteId = null; // Das ist g:id aus dem Feed
    ...
    public function setRemoteId(string $remoteId): self { $this->remoteId = $remoteId; return $this; }
    ...
    public function setImageLink(?string $imageLink): self { $this->imageLink = $imageLink; return $this; }
    ...
    // ... unten die Getter und Setter hinzufügen
    public function getSalePrice(): ?float { return $this->salePrice !== null ? (float)$this->salePrice : null; }
    public function setSalePrice(?float $salePrice): self { $this->salePrice = $salePrice !== null ? (string)$salePrice : null; return $this; }

    /**
     * Hilfsmethode für dein Frontend: Gibt den aktuell gültigen Preis zurück
     */
    public function getActivePrice(): float
    {
        return $this->getSalePrice() !== null ? $this->getSalePrice() : $this->getPrice();
    }
}
